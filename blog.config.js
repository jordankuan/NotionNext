...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '7541fd26cded4b7b889ae16498c70068',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-HK', // e.g 'zh-HK, zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: 2012, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  // 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '澳門積思資訊科技有限公司',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '澳門積思資訊科技有限公司', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '公司現時正在轉型AI應該方向, 可以提供從歷史數據，用ML分析出未來每一步的最優解', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://3jsi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CMS, 資訊管理系統，澳門積思資訊科技有限公司, 軟件開發, ', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@3jsi.com', // 邮箱地址 例如mail@tangly1024.com
